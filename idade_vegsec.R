#### boxplots de vegetação secundária por categoria de idade ####
...
#Área de vegetação secundária por área desmatada 
...
names(u_vs.area)<- paste0("Área vegetação secundária ", seq(5,30, by=5))
u_vs.area
capture.output(u_vs.area, file = "testeU_vsarea.txt")

###################
#Area de vegetação secundária ao longo do tempo
